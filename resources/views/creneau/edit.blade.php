                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" name="heure_debut" id="duree">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="heure_Fin" class="form-label">Heure Fin</label>
                                    <input type="time" class="form-control" name="heure_Fin" id="duree">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="user_id">
                                        @foreach ($users as $user)
                                            @if($user->role=='professeur')
                                                <option selected value="{{$user->id}}">{{$user->nom}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
